  ...
  return (
    <section className="service_section section_space_lg">
      <div className="container">
        ...
        <div className="row">
          <div className="col-lg-4 col-md-6 col-sm-6">
            <div className="service_item">
              ...
              <div className="item_content">
                <h3 className="item_title">Mechanika</h3>
                <p>
                  Nasza usługa mechaniki samochodowej to gwarancja, że Twój
                  pojazd będzie działać sprawnie i bezpiecznie.
                </p>
                <a className="btn-link" href="service_details.html">
          ...
          <div className="col-lg-4 col-md-6 col-sm-6">
            <div className="service_item">
              <div className="item_icon">
                ...
                >
                  <path
                    fillRule="evenodd"
                    clipRule="evenodd"
                    d="M14.521 20.2881L11.6342 36.9322H3.06641L7.94341 20.2881H14.521Z"
                    fill="#EDEDED"
                  />
                  <path
                    fillRule="evenodd"
                    clipRule="evenodd"
                    d="M0 6.43709H24.1346V0H0V6.43709Z"
                    fill="#EDEDED"
                  />
                  <path
                    fillRule="evenodd"
                    clipRule="evenodd"
                    d="M0 10.6744H24.1346V8.19287H0V10.6744Z"
                    fill="#EDEDED"
                  />
                  <path
                    fillRule="evenodd"
              ...
              <div className="item_content">
                <h3 className="item_title">Wymiana rozrządów BMW</h3>
                <p>
                  Wykonujemy kompleksową wymianę rozrządów w samochodach marki
                  BMW, zapewniając doskonałą wydajność i niezawodność Twojego
                  pojazdu.
                </p>
                <a className="btn-link" href="service_details.html">
                  <span className="btn_icon">
          ...
          <div className="col-lg-4 col-md-6 col-sm-6">
            <div className="service_item">
              ...
              <div className="item_content">
                <h3 className="item_title">Kontrola przed zakupowa</h3>
                <p>
                  Oferujemy profesjonalne diagnozy i dokładne wyceny napraw, by
                  zapewnić Ci przejrzystość i pewność w podejmowaniu decyzji
                  dotyczących Twojego samochodu.
                </p>
                <a className="btn-link" href="service_details.html">
                  <span className="btn_icon">
                    <i className="fa-regular fa-angle-right"></i>
          ...
          <div className="col-lg-4 col-md-6 col-sm-6">
            <div className="service_item">
              <div className="item_icon">
                ...
                >
                  ...
                  <path
                    fillRule="evenodd"
                    clipRule="evenodd"
                    d="M5.28809 3.65498H14.5848V0H5.28809V3.65498Z"
                    fill="#EDEDED"
                  />
                  <path
                    fillRule="evenodd"
              ...
              <div className="item_content">
                <h3 className="item_title">Klimatyzacja</h3>
                <p>
                  Serwisujemy, naprawiamy i montujemy, układy klimatyzacji w
                  większości typach pojazdów.
                </p>
                <a className="btn-link" href="service_details.html">
                  <span className="btn_icon">
                    <i className="fa-regular fa-angle-right"></i>
          ...
          <div className="col-lg-4 col-md-6 col-sm-6">
            <div className="service_item">
              <div className="item_icon">
                ...
                >
                  ...
                  <path
                    fillRule="evenodd"
                    clipRule="evenodd"
                    d="M0 10.0019H47.8171V6.63818H0V10.0019Z"
                    fill="#EDEDED"
                  />
                  <path
                    fillRule="evenodd"
              ...
              <div className="item_content">
                <h3 className="item_title">Elektryka</h3>
                <p>
                  Nasze usługi elektryki samochodowej to klucz do utrzymania
                  bezpiecznych i sprawnych układów elektrycznych w Twoim aucie.
                </p>
                <a className="btn-link" href="service_details.html">
                  <span className="btn_icon">
                    <i className="fa-regular fa-angle-right"></i>
          ...
          <div className="col-lg-4 col-md-6 col-sm-6">
            <div className="service_item">
              <div className="item_icon">
                ...
                >
                  <path
                    fillRule="evenodd"
                    clipRule="evenodd"
                    d="M46.9994 8.61544V11.8336H33.3605C32.7074 13.6304 30.9965 14.9052 28.9749 14.9052C26.9609 14.9052 25.2501 13.6304 24.5969 11.8336H10.958V8.61544H24.5893C25.0483 7.34658 26.0438 6.34427 27.3032 5.86143V3.60644H26.4712V2.10596H31.4785V3.60644H30.6551V5.86143C31.9137 6.34427 32.91 7.3551 33.3682 8.61544H46.9994Z"
                    fill="#EDEDED"
                  />
                  <path
                    fillRule="evenodd"
              ...
              <div className="item_content">
                <h3 className="item_title">Ogrzewania postojowe</h3>
                <p>
                  Zainstalujemy i serwisujemy efektywne ogrzewanie postojowe,
                  zapewniając Ci ciepło i wygodę w zimowe dni.
                </p>
                <a className="btn-link" href="service_details.html">
                  <span className="btn_icon">
                    <i className="fa-regular fa-angle-right"></i>
        ...
        <div className="btn_wrap text-center d-lg-none d-block">
          <a className="btn btn-primary" href="service.html">
            <span className="btn_text">All Services</span>
          </a>
        </div>
